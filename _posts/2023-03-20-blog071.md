...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230320/Fig_chla_week.png){:             width="600px"}{: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230320/Fig_cyan.png){: width="600px"}{: .align-center}
<br clear="all" />
